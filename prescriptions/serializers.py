...
class PrescriptionSerializer(serializers.ModelSerializer):
    ...
    medicines = MedicineSerializer(source="medicine_set", many=True, required=False)
    medical_tests = MedicalTestSerializer(source="medicaltest_set", many=True, required=False)

    class Meta:
        model = Prescription
        fields = [
            "id", "users", "doctor", "prescription_image",
            "next_appointment_date", "patient", "medicines", "medical_tests",
        ]
        read_only_fields = ["users"]

    def _create_medicines(self, medicines_data, prescription):
    ...
    def create(self, validated_data):
        ...
        # ✅ Fixed method call
        self._create_medicines(medicines_data, prescription)
    ...
    def update(self, instance, validated_data):
        ...
        # ✅ Fixed method call
        self._create_medicines(medicines_data, instance)
